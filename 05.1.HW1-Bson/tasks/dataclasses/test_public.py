...
def test_marshal_keep_nt_typeinfo_double_inside_empty() -> None:
    ...
    inout_test(
        ...
        exp=bytes([132, 0, 0, 0,
                       3, 97, 0, 36, 0, 0, 0,
                           3, 98, 0, 5, 0, 0, 0, 0,
                               5, 95, 95, 109, 101, 116, 97, 100, 97, 116, 97, 95, 95, 0, 4, 0, 0, 0,
                               128, 110, 116, 45, 48, 0,
                               5, 95, 95, 109, 101, 116, 97, 100, 97, 116, 97, 95, 95, 0, 69, 0, 0, 0,
                               128, 0,
                               68, 0, 0, 0,
                                   3, 116, 121, 112, 101, 115, 0, 56, 0, 0, 0,
                                   3, 110, 116, 45, 48, 0, 45, 0, 0, 0,
                                   3, 100, 101, 102, 97, 117, 108, 116, 115, 0, 5, 0, 0, 0, 0,
                                   4, 102, 105, 101, 108, 100, 115, 0,
                                 5, 0, 0, 0, 0, 2, 110, 97, 109, 101, 0, 2, 0, 0, 0, 67, 0, 0, 0, 0, 0]),
        mapper=m,
    )
...
def test_unmarshal_keep_nt_typeinfo_double_inside_empty() -> None:
    C = nt('C', [])
    m = bson.Mapper(keep_types=True)
    result = m.unmarshal(bytes([132, 0, 0, 0,
                       3, 97, 0, 36, 0, 0, 0,
                           3, 98, 0, 5, 0, 0, 0, 0,
                               5, 95, 95, 109, 101, 116, 97, 100, 97, 116, 97, 95, 95, 0, 4, 0, 0, 0,
                               128, 110, 116, 45, 48, 0,
...
def test_marshal_keep_nt_typeinfo_inside_empty() -> None:
    ...
    inout_test(
        ...
        exp=bytes([120, 0, 0, 0,
              3, 97, 0,
              5, 0, 0, 0, 0,
              5, 95, 95, 109, 101, 116, 97, 100, 97, 116, 97, 95, 95, 0, 88, 0, 0, 0, 128,
              0, 87, 0, 0, 0, 2, 99, 104, 105, 108, 100, 114, 101, 110, 0,
              5, 0, 0, 0, 110, 116, 45, 48, 0, 3, 116, 121, 112, 101, 115, 0, 56, 0, 0, 0,
              3, 110, 116, 45, 48, 0, 45, 0, 0, 0, 3, 100, 101, 102, 97, 117, 108, 116, 115, 0,
              5, 0, 0, 0, 0, 4, 102, 105, 101, 108, 100, 115, 0, 5, 0, 0, 0, 0, 2, 110, 97, 109, 101,
              0, 2, 0, 0, 0, 67, 0, 0, 0, 0, 0]),
        mapper=m,
    )
...
def test_unmarshal_keep_nt_typeinfo_inside_empty() -> None:
    C = nt('C', [])
    m = bson.Mapper(keep_types=True)
    result = m.unmarshal(bytes([120, 0, 0, 0,
              3, 97, 0,
              5, 0, 0, 0, 0,
              5, 95, 95, 109, 101, 116, 97, 100, 97, 116, 97, 95, 95, 0, 88, 0, 0, 0, 128,
              0, 87, 0, 0, 0, 2, 99, 104, 105, 108, 100, 114, 101, 110, 0,
...
def test_marshal_nt_as_root() -> None:
    ...
    inout_test(                  
        inp=C(),
        exp=bytes([108, 0, 0, 0,
              5, 95, 95, 109, 101, 116, 97, 100, 97, 116, 97, 95, 95, 0, 84, 0, 0, 0,
              128, 0, 83, 0, 0, 0, 2, 115, 101, 108, 102, 0,
              5, 0, 0, 0, 110, 116, 45, 48, 0, 3, 116, 121, 112, 101, 115, 0, 56, 0, 0, 0,
              3, 110, 116, 45, 48, 0, 45, 0, 0, 0, 3, 100, 101, 102, 97, 117, 108, 116, 115, 0,
              5, 0, 0, 0, 0, 4, 102, 105, 101, 108, 100, 115, 0, 5, 0, 0, 0, 0, 2,
              110, 97, 109, 101, 0, 2, 0, 0, 0, 67, 0, 0, 0, 0, 0]),
        mapper=m,
    )
...
def test_unmarshal_nt_as_root() -> None:
    C = nt('C', [])
    m = bson.Mapper(keep_types=True)
    result = m.unmarshal(bytes([108, 0, 0, 0,
              5, 95, 95, 109, 101, 116, 97, 100, 97, 116, 97, 95, 95, 0, 84, 0, 0, 0,
              128, 0, 83, 0, 0, 0, 2, 115, 101, 108, 102, 0,
              5, 0, 0, 0, 110, 116, 45, 48, 0, 3, 116, 121, 112, 101, 115, 0, 56, 0, 0, 0,
              3, 110, 116, 45, 48, 0, 45, 0, 0, 0, 3, 100, 101, 102, 97, 117, 108, 116, 115, 0,
...
def test_marshal_keep_dc_typeinfo_double_inside_empty() -> None:
    ...
    inout_test(
        inp={'a': {'b': C()}},
        exp=bytes([185, 0, 0, 0,
            3, 97, 0, 36, 0, 0, 0, 3, 98, 0, 5, 0, 0, 0, 0,
            5, 95, 95, 109, 101, 116, 97, 100, 97, 116, 97, 95, 95, 0, 4, 0, 0, 0, 128, 100, 99, 45, 48, 0,
            5, 95, 95, 109, 101, 116, 97, 100, 97, 116, 97, 95, 95, 0, 122, 0, 0, 0, 128, 0, 121, 0, 0, 0,
            3, 116, 121, 112, 101, 115, 0, 109, 0, 0, 0, 3, 100, 99, 45, 48, 0, 98, 0, 0, 0,
            3, 97, 110, 110, 111, 116, 97, 116, 105, 111, 110, 115, 0, 5, 0, 0, 0, 0,
            2, 110, 97, 109, 101, 0, 2, 0, 0, 0, 67, 0, 3, 112, 97, 114, 97, 109, 115, 0, 55, 0, 0, 0,
            8, 101, 113, 0, 1, 8, 102, 114, 111, 122, 101, 110, 0, 0, 8, 105, 110, 105, 116, 0, 1,
            8, 111, 114, 100, 101, 114, 0, 0, 8, 114, 101, 112, 114, 0, 1,
            8, 117, 110, 115, 97, 102, 101, 95, 104, 97, 115, 104, 0, 0, 0, 0, 0, 0, 0]),
        mapper=m,
    )
...
def test_unmarshal_keep_dc_typeinfo_double_inside_empty() -> None:
    ...
    m = bson.Mapper(keep_types=True)
    result = m.unmarshal(bytes([185, 0, 0, 0,
            3, 97, 0, 36, 0, 0, 0, 3, 98, 0, 5, 0, 0, 0, 0,
            5, 95, 95, 109, 101, 116, 97, 100, 97, 116, 97, 95, 95, 0, 4, 0, 0, 0, 128, 100, 99, 45, 48, 0,
            5, 95, 95, 109, 101, 116, 97, 100, 97, 116, 97, 95, 95, 0, 122, 0, 0, 0, 128, 0, 121, 0, 0, 0,
            3, 116, 121, 112, 101, 115, 0, 109, 0, 0, 0, 3, 100, 99, 45, 48, 0, 98, 0, 0, 0,
...
def test_marshal_keep_dc_typeinfo_single_inside_empty() -> None:
    ...
    inout_test(
        ...
        exp=bytes([173, 0, 0, 0,
            3, 97, 0, 5, 0, 0, 0, 0,
            5, 95, 95, 109, 101, 116, 97, 100, 97, 116, 97, 95, 95, 0, 141, 0, 0,0, 128, 0, 140, 0, 0, 0,
            2, 99, 104, 105, 108, 100, 114, 101, 110, 0, 5, 0, 0, 0, 100, 99, 45, 48, 0,
            3, 116, 121, 112, 101, 115, 0, 109, 0, 0, 0, 3, 100, 99, 45, 48, 0, 98, 0, 0, 0,
            3, 97, 110, 110, 111, 116, 97, 116, 105, 111, 110, 115, 0, 5, 0, 0, 0, 0,
            2, 110, 97, 109, 101, 0, 2, 0, 0, 0, 67, 0, 3, 112, 97, 114, 97, 109, 115, 0, 55, 0, 0, 0,
            8, 101, 113, 0, 1, 8, 102, 114, 111, 122, 101, 110, 0, 0, 8, 105, 110, 105, 116, 0, 1,
...
def test_unmarshal_keep_dc_typeinfo_single_inside_empty() -> None:
    ...
    m = bson.Mapper(keep_types=True)
    result = m.unmarshal(bytes([173, 0, 0, 0,
            3, 97, 0, 5, 0, 0, 0, 0,
            5, 95, 95, 109, 101, 116, 97, 100, 97, 116, 97, 95, 95, 0, 141, 0, 0,0, 128, 0, 140, 0, 0, 0,
            2, 99, 104, 105, 108, 100, 114, 101, 110, 0, 5, 0, 0, 0, 100, 99, 45, 48, 0,
            3, 116, 121, 112, 101, 115, 0, 109, 0, 0, 0, 3, 100, 99, 45, 48, 0, 98, 0, 0, 0,
...
def test_marshal_keep_dc_typeinfo_outside_empty() -> None:
    ...
    inout_test(
        inp=C(),
        exp=bytes([161, 0, 0, 0,
            5, 95, 95, 109, 101, 116, 97, 100, 97, 116, 97, 95, 95, 0, 137, 0, 0, 0, 128, 0, 136, 0, 0, 0,
            2, 115, 101, 108, 102, 0, 5, 0, 0, 0, 100, 99, 45, 48, 0, 3, 116, 121, 112, 101, 115, 0, 109, 0, 0, 0,
            3, 100, 99, 45, 48, 0, 98, 0, 0, 0,
            3, 97, 110, 110, 111, 116, 97, 116, 105, 111, 110, 115, 0, 5, 0, 0, 0, 0,
            2, 110, 97, 109, 101, 0, 2, 0, 0, 0, 67, 0, 3, 112, 97, 114, 97, 109, 115, 0, 55, 0, 0, 0,
            8, 101, 113, 0, 1, 8, 102, 114, 111, 122, 101, 110, 0, 0, 8, 105, 110, 105, 116, 0, 1,
            8, 111, 114, 100, 101, 114, 0, 0, 8, 114, 101, 112, 114, 0, 1,
